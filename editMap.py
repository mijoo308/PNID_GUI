...
class GraphicsScene(QGraphicsScene):
    ...
    def outline(self):
        ...
        mapImg = self.img.copy(x, y, width,height)
    ...
    def cutoffImg(self):
        ...
        painterFrame.fillRect(self.exceptRegion, Qt.transparent)
        painterFrame.end()
        self.removeItem(self.graphicsPixmapItem)
        self.graphicsPixmapItem = QGraphicsPixmapItem(self.mapImg)
        self.addItem(self.graphicsPixmapItem)
        self.mapImg.save('/Users/hanhyeji/Documents/File/EditImg.png', "png")